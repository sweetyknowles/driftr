...
Post.create(city_id: san_francisco.id, title: "Amazing Pubs!", text: "Amazing pubs in London!")
Post.create(city_id: london.id, title: "Great Smog!", text: "The smog is killing me.")